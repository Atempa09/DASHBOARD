...
$sql = "SELECT Folio_cc, OT_ginp, OT_didt, fecha_de_emision, fecha_de_rececepcion, Asunto, referencia, CDT_asignado, CL_asignado, CAC_asignado, JEF_asignado, Normal, Urgente, extraurgente, ProcesoConcluido FROM principal WHERE ProcesoConcluido = 1 ORDER BY ID DESC";
...
<html lang="es">
    <head>
        ...
        <title>PROCESOS CONCLUIDOS</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Folios Con Proceso Concluido</h1>
                        <div class="card mb-4">
                                    ...
                                    <table class="table table-bordered" id="foliosTable" width="100%" cellspacing="30">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><i class="fa fa-check"></i></td> <!-- Ícono de palomita -->
                                            </tr>  
                                            <?php
                                            }
                                                mysqli_close($mysqli);
