...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="inicio.php">SISTEMAS WEB GINP</a>
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid"><h1 class="mt-4">ASIGNACIÓN DE PRINCIPAL - CDT</h1>
                    <div class="row">
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <td><?php echo $mostrar['CDT_num']; ?></td>
                                                <td><?php echo $mostrar['fecha_recibo_cdt']; ?></td>
                                                <td><?php echo $mostrar['OT_ginp']; ?></td>
