...
$sql = "SELECT Folio_cc, OT_ginp, OT_didt, fecha_de_emision, fecha_de_rececepcion, Asunto, referencia, CDT_asignado, CL_asignado, CAC_asignado, JEF_asignado, Urgente, ProcesoConcluido FROM principal WHERE Urgente = 1 ORDER BY ID DESC";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Folios Con Asignación Urgentes</h1>
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>TOTAL DE FOLIOS ASIGNADOS</div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($mostrar['Urgente'] == 1) { ?>
                                                        <i class="fas fa-exclamation-circle"></i></td>  <!-- Ícono de precaucion -->
                                                    <?php } else { echo ""; } ?>
                                                <td>
                                                    <?php if ($mostrar['ProcesoConcluido'] == 1) { ?>
                                                        <i class="fa fa-check"></i>  <!-- Ícono de palomita -->
                                                    <?php }
                                                    else { ?>
                                                        <i class="fa fa-times"></i> <!-- Ícono de tache -->
                                                    <?php } ?>
                                                </td>
                                            </tr>  
                                            <?php
