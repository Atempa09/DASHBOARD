...
$sql = "SELECT Folio_cc, OT_ginp, OT_didt, fecha_de_emision, fecha_de_rececepcion, Asunto, referencia, CDT_asignado, CL_asignado, CAC_asignado, JEF_asignado, Normal FROM principal WHERE Normal = 1 ORDER BY ID DESC";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Folios Con Asignación Normal</h1>
                        <div class="card mb-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($mostrar['Normal'] == 1) { ?>
                                                        <i class="fas fa-check-circle"></i></td>  <!-- Ícono de palomita redondo-->
                                                    <?php } else { echo ""; } ?>
                                                </td>
                                            </tr>  
                                            <?php
