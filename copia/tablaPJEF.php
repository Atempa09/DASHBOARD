            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">ASIGNACIÓN DE PRINCIPAL - JEF</h1>
                        <div class="card mb-4">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $mostrar['Num_JEF']; ?></td>
                                            <td><?php echo $mostrar['GINP']; ?></td>
                                            <td><?php echo $mostrar['DIDT']; ?></td>
                                            <td><?php echo $mostrar['Fecha']; ?></td>
                                            <td><?php echo $mostrar['Folio']; ?></td>
                                            <td><?php echo $mostrar['OTginp']; ?></td>
                                            <td><?php echo $mostrar['OTdidt']; ?></td>
                                            <td><?php echo $mostrar['Asunto']; ?></td>
                                        </tr>
                                        <?php } ?>
                                        </tbody>
