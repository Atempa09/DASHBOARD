...
$sql = "SELECT Folio_cc, OT_ginp, OT_didt, fecha_de_emision, fecha_de_rececepcion, Asunto, referencia, CDT_asignado, CL_asignado, CAC_asignado, JEF_asignado, Normal, Urgente, extraurgente FROM principal ORDER BY ID DESC";
			...
			<div id="layoutSidenav_content">
				<main>
					<div class="container-fluid">
						<h1 class="mt-4">Total De Folios Asignados</h1>
						<div class="card mb-4">
