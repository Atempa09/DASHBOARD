...
$sql = "SELECT Folio_cc, OT_ginp, OT_didt, fecha_de_emision, fecha_de_rececepcion, Asunto, referencia, CDT_asignado, CL_asignado, CAC_asignado, JEF_asignado,extraurgente FROM principal WHERE extraurgente = 1 ORDER BY ID DESC";
...
<html lang="es">
    <head>
        ...
        <title>FOLIOS EXTRAURGENTES</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Folios Con Asignación ExtraUrgentes</h1>
                        <div class="card mb-4">
